...
export const AI_PROVIDER_CATALOG: readonly AiProviderCatalogEntry[] = [
  { label: 'OpenAI', value: 'openai', homepage: 'https://openai.com', protocol: 'openai-responses', baseUrl: 'https://api.openai.com/v1', model: '', customBaseUrl: false, supportsEmbedding: true, hint: '官方接口，填写 API Key 后即可使用，也可拉取账号可用模型。' },
  { label: 'Anthropic', value: 'anthropic', homepage: 'https://anthropic.com', protocol: 'anthropic', baseUrl: 'https://api.anthropic.com/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: 'Claude 官方接口，使用 Anthropic Messages 协议。' },
  { label: 'DeepSeek', value: 'deepseek', homepage: 'https://www.deepseek.com', protocol: 'openai-chat', baseUrl: 'https://api.deepseek.com/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: 'DeepSeek 官方接口，支持 deepseek-chat 和 deepseek-reasoner。' },
  ...
  { label: 'SiliconFlow（硅基流动）', value: 'siliconflow', homepage: 'https://siliconflow.cn', protocol: 'openai-chat', baseUrl: 'https://api.siliconflow.cn/v1', model: '', customBaseUrl: false, supportsEmbedding: true, hint: '硅基流动官方接口，填写 Key 后拉取可用模型。' },
  ...
  { label: 'Groq', value: 'groq', homepage: 'https://groq.com', protocol: 'openai-chat', baseUrl: 'https://api.groq.com/openai/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: 'Groq 官方 OpenAI 兼容接口。' },
  { label: 'Mistral AI', value: 'mistral', homepage: 'https://mistral.ai', protocol: 'openai-chat', baseUrl: 'https://api.mistral.ai/v1', model: '', customBaseUrl: false, supportsEmbedding: true, hint: 'Mistral 官方 OpenAI 兼容接口。' },
  { label: 'xAI', value: 'xai', homepage: 'https://x.ai', protocol: 'openai-chat', baseUrl: 'https://api.x.ai/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: 'xAI 官方 OpenAI 兼容接口。' },
  { label: 'Google Gemini', value: 'gemini', homepage: 'https://ai.google.dev', protocol: 'openai-chat', baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai', model: '', customBaseUrl: false, supportsEmbedding: false, hint: 'Google 官方 OpenAI 兼容入口。' },
  { label: '火山方舟', value: 'volcengine', homepage: 'https://www.volcengine.com/product/ark', protocol: 'openai-chat', baseUrl: 'https://ark.cn-beijing.volces.com/api/v3', model: '', customBaseUrl: false, supportsEmbedding: false, hint: '火山方舟官方接口，模型名称请填写推理接入点 ID。' },
  { label: '腾讯混元 Hunyuan', value: 'hunyuan', homepage: 'https://cloud.tencent.com/product/hunyuan', protocol: 'openai-chat', baseUrl: 'https://api.hunyuan.cloud.tencent.com/v1', model: '', customBaseUrl: false, supportsEmbedding: true, hint: '腾讯混元官方 OpenAI 兼容接口。' },
  { label: '百度千帆 Qianfan', value: 'qianfan', homepage: 'https://cloud.baidu.com/product/wenxinworkshop', protocol: 'openai-chat', baseUrl: 'https://qianfan.baidubce.com/v2', model: '', customBaseUrl: false, supportsEmbedding: false, hint: '百度千帆 OpenAI 兼容接口（v2 兼容模式）。' },
  ...
  { label: '零一万物 Yi', value: 'lingyiwanwu', homepage: 'https://www.lingyiwanwu.com', protocol: 'openai-chat', baseUrl: 'https://api.lingyiwanwu.com/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: '零一万物 Yi 官方 OpenAI 兼容接口。' },
  { label: '百川智能 Baichuan', value: 'baichuan', homepage: 'https://www.baichuan-ai.com', protocol: 'openai-chat', baseUrl: 'https://api.baichuan-ai.com/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: '百川智能官方 OpenAI 兼容接口。' },
  { label: '昆仑万维天工', value: 'tiangong', homepage: 'https://www.tiangong.cn', protocol: 'openai-chat', baseUrl: 'https://api.tiangong.tech/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: '昆仑万维天工官方 OpenAI 兼容接口。' },
  ...
  { label: 'Fireworks AI', value: 'fireworks', homepage: 'https://fireworks.ai', protocol: 'openai-chat', baseUrl: 'https://api.fireworks.ai/inference/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: 'Fireworks AI 高性能推理 OpenAI 兼容接口。' },
  { label: 'Cerebras', value: 'cerebras', homepage: 'https://www.cerebras.ai', protocol: 'openai-chat', baseUrl: 'https://api.cerebras.ai/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: 'Cerebras 超高速推理 OpenAI 兼容接口。' },
  ...
  { label: '科大讯飞（星火）', value: 'iflytek', homepage: 'https://xinghuo.xfyun.cn', protocol: 'openai-chat', baseUrl: 'https://spark-api-open.xf-yun.com/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: '科大讯飞星火大模型 OpenAI 兼容接口，支持 spark 系列模型。' },
  { label: '商汤 SenseNova', value: 'sensenova', homepage: 'https://platform.sensenova.cn', protocol: 'openai-chat', baseUrl: 'https://api.sensenova.cn/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: '商汤日日新大模型 OpenAI 兼容接口，支持 SenseNova 系列。' },
  { label: '日日新（商汤）', value: 'sensenova-rrx', homepage: 'https://platform.sensenova.cn', protocol: 'openai-chat', baseUrl: 'https://api.sensenova.cn/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: '商汤日日新大模型 OpenAI 兼容接口，支持日日新系列模型。' },
  { label: '小米 MiLM', value: 'xiaomi', homepage: 'https://www.mi.com', protocol: 'openai-chat', baseUrl: 'https://api.xiaomi.com/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: '小米 MiLM 大模型 OpenAI 兼容接口，请填写有效 Base URL 与模型名。' },
  { label: 'MIMO', value: 'mimo', homepage: 'https://www.mimo.com', protocol: 'openai-chat', baseUrl: 'https://api.mimo.com/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: 'MIMO 大模型 OpenAI 兼容接口，请填写有效 Base URL 与模型名。' },
  { label: '美团 LongCat（龙猫）', value: 'longcat', homepage: 'https://longcat.meituan.com', protocol: 'openai-chat', baseUrl: 'https://api.longcat.com/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: '美团 LongCat（龙猫）大模型 OpenAI 兼容接口，请填写有效 Base URL 与模型名。' },
  ...
  { label: 'AMD 基元律动', value: 'amd', homepage: 'https://www.amd.com', protocol: 'openai-chat', baseUrl: 'https://api.amd.com/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: 'AMD 基元律动大模型 OpenAI 兼容接口，请填写有效 Base URL 与模型名。' },
  ...
  { label: 'AtomGit', value: 'atomgit', homepage: 'https://atomgit.com/setting/token-classic', protocol: 'openai-chat', baseUrl: 'https://api-ai.gitcode.com/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: 'AtomGit（GitCode）模型平台 OpenAI 兼容接口，在官网生成 Token 后填入。' },
