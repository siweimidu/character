...
export const AI_PROVIDER_CATALOG: readonly AiProviderCatalogEntry[] = [
  ...
  { label: '基元律动', value: 'jiyuan', homepage: 'https://platform.lingyiwanwu.com', protocol: 'openai-chat', baseUrl: 'https://api.lingyiwanwu.com/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: '基元律动（零一万物）大模型 OpenAI 兼容接口，请填写有效 Base URL 与模型名。' },
