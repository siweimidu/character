...
export const AI_PROVIDER_CATALOG: readonly AiProviderCatalogEntry[] = [
  ...
  { label: 'OmniRouter（本地路由）', value: 'omnirouter', homepage: 'https://github.com/mizti/omnirouter', protocol: 'openai-chat', baseUrl: 'http://localhost:20128/v1/models', model: '', customBaseUrl: true, supportsEmbedding: false, hint: 'OmniRouter 本地模型路由（OpenAI 兼容），默认端口 20128，可在此拉取路由后的模型列表。' },
  { label: 'OmniRoute（本地路由·旧版）', value: 'omniroute', homepage: 'https://github.com/mizti/omniroute', protocol: 'openai-chat', baseUrl: 'http://localhost:3000/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: 'OmniRoute 本地模型路由旧版默认端口 3000，兼容历史配置。' },
  { label: 'FreeLLMAPI（本地路由）', value: 'freellmapi', homepage: 'https://freellmapi.com', protocol: 'openai-chat', baseUrl: 'http://localhost:3001/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: 'FreeLLMAPI 本地模型网关（OpenAI 兼容），默认端口 3001，可在 /v1 拉取可用模型。' },
