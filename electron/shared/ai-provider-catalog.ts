...
export const AI_PROVIDER_CATALOG: readonly AiProviderCatalogEntry[] = [
  ...
  { label: 'ModelScope（魔搭社区）', value: 'modelscope', homepage: 'https://www.modelscope.cn', protocol: 'openai-chat', baseUrl: 'https://api-inference.modelscope.cn/v1', model: '', customBaseUrl: false, supportsEmbedding: false, hint: 'ModelScope（魔搭/魔塔社区）官方 OpenAI 兼容接口，模型名格式如 Qwen/Qwen2.5-7B-Instruct。' },
  ...
  { label: 'Google Gemini', value: 'gemini', homepage: 'https://aistudio.google.com', protocol: 'openai-chat', baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai', model: 'models/gemini-3.1-flash-lite', customBaseUrl: false, supportsEmbedding: false, hint: 'Google 官方 OpenAI 兼容入口。' },
  ...
  { label: '商汤', value: 'sensenova', homepage: 'https://platform.sensenova.cn', protocol: 'openai-chat', baseUrl: 'https://api.sensenova.cn/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: '商汤日日新（SenseNova）大模型 OpenAI 兼容接口，支持日日新 / SenseNova 系列模型。' },
  ...
  { label: '基元律动', value: 'jiyuan', homepage: 'https://tokenrhythm.studio/', protocol: 'openai-chat', baseUrl: 'https://tokenrhythm.studio/v1', model: '', customBaseUrl: true, supportsEmbedding: false, hint: '基元律动（OpenSquilla 智能路由）多模型 API，支持 OpenAI 与 Anthropic 协议。' },
  ...
  { label: 'AtomGit（GitCode）', value: 'atomgit', homepage: 'https://atomgit.com/setting/token-classic', protocol: 'openai-chat', baseUrl: 'https://api-ai.gitcode.com/v1', model: 'Qwen/Qwen3-VL-8B-Instruct', customBaseUrl: true, supportsEmbedding: false, hint: 'AtomGit（GitCode）模型平台 OpenAI 兼容接口，默认视觉模型 Qwen/Qwen3-VL-8B-Instruct，在官网生成 Token 后填入。' },
