...
declare global {
  ...
  interface Window {
    characterArc: {
      ...
      transcribeSpeech: (payload: { settings: unknown; audioData: Uint8Array | string; audioType: string }) => Promise<{
        success: boolean
      ...
      agentModules: {
        ...
        mcpServerList: () => Promise<import('@shared/agent-modules').McpServerDefinition[]>,
        mcpServerAdd: (payload: Record<string, unknown>) => Promise<import('@shared/agent-modules').McpServerDefinition>,
