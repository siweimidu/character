...
export const themePresets: ThemePreset[] = [
  ...
  },
  {
    ...
    primary: '#6750a4',
    primaryHover: '#7a6bb5',
    primaryPressed: '#5a3f96',
    darkPrimary: '#d0bcff',
    darkPrimaryHover: '#e0d3ff',
    darkPrimaryPressed: '#b39cf0',
    softBackground: '#f3eeff',
    light: {
      bgBody: '#faf8fc',
      bgWeak: '#fcfbfe',
      bgSurface: '#ffffff',
      bgSurfaceHover: '#f2eef7',
      bgSidebar: '#f0ecf7',
      sidebarBorder: '#e3dcf0',
      textPrimary: '#1c1b1f',
    ...
    dark: {
      ...
      bgWeak: '#1a1820',
      bgSurface: '#211f27',
      bgSurfaceHover: '#2b2833',
      bgSidebar: '#17141c',
      sidebarBorder: '#332f3d',
      textPrimary: '#e8def8',
      ...
      primary: '#d0bcff',
      primaryHover: '#e0d3ff',
      primaryPressed: '#b39cf0',
      primarySoft: 'color-mix(in srgb, #d0bcff 18%, #221f2b)',
      shadowSm: '0 1px 3px rgba(0, 0, 0, 0.4)',
      shadowMd: '0 8px 24px rgba(0, 0, 0, 0.5)',
      shadowLg: '0 18px 48px rgba(0, 0, 0, 0.55)',
      bgMix: '#1d1a23',
  ...
  },
  {
    ...
    primary: '#1664ff',
    primaryHover: '#387bff',
    primaryPressed: '#0055ff',
    darkPrimary: '#4080ff',
    darkPrimaryHover: '#6b9bff',
    darkPrimaryPressed: '#1664ff',
    softBackground: '#f3f7ff',
    light: {
      bgBody: '#f2f4f8',
      bgWeak: '#fafbfc',
      bgSurface: '#ffffff',
      bgSurfaceHover: '#f0f2f5',
      bgSidebar: '#f7f8fa',
      sidebarBorder: '#eaedf1',
      textPrimary: '#1d2129',
    ...
    dark: {
      ...
      bgWeak: '#242a33',
      bgSurface: '#242a33',
      bgSurfaceHover: '#2f3640',
      bgSidebar: '#1f242c',
      sidebarBorder: '#343a43',
      textPrimary: '#e5e6eb',
      ...
      primary: '#4080ff',
      primaryHover: '#6b9bff',
      primaryPressed: '#1664ff',
      primarySoft: 'color-mix(in srgb, #4080ff 18%, #252b35)',
      shadowSm: '0 1px 3px rgba(0, 0, 0, 0.4)',
      shadowMd: '0 8px 24px rgba(0, 0, 0, 0.5)',
      shadowLg: '0 18px 48px rgba(0, 0, 0, 0.55)',
      bgMix: '#20252d',
